...
class Calculator extends React.Component {
  ...
  render() {
    return /*#__PURE__*/(
      React.createElement("div", { className: "border calculator" }, /*#__PURE__*/
      React.createElement("div", { className: "display text-end" }, /*#__PURE__*/
      React.createElement("div", { className: "formula", id: "formula" },
      this.state.formula), /*#__PURE__*/

      React.createElement("div", { className: "output", id: "display" },
      this.state.current)), /*#__PURE__*/


      React.createElement("div", { className: "buttons" },
      buttonList.map((btn, index) => /*#__PURE__*/
